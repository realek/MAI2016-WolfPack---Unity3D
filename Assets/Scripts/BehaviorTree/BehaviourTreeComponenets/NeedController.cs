...
//        if (_myNeeds.GetNeed(NeedType.Hunger) > _bearableHunger) {
//            TooHungry();
//        }
//    }
...
//        _myNeeds.EditNeed(NeedType.Energy, _enEdNoSleep);
//    }

//    private void Idle() {
//        //if staying in one place
//        _myNeeds.EditNeed(NeedType.Energy, _enEdIdle);
//    }

//    private void Running() {
//        //if in run state
//        _myNeeds.EditNeed(NeedType.Energy, _enEdRun);
//    }
//    #endregion
...
//        //if eating an animal
//        _myNeeds.EditNeed(NeedType.Hunger, _huEdFeed);
//    }

//    private void GrowHungry() {
//        //if a set amount of time has passed since last food & not in sleep state
//        _myNeeds.EditNeed(NeedType.Hunger, _huEdNoFeedAwake);
//    }
//    #endregion
...
//        _myNeeds.EditNeed(NeedType.Thirst, _thEdNoDrinkAwake);
//    }

//    private void DrinkingWater() {
//        //if drinking water
//        _myNeeds.EditNeed(NeedType.Thirst, _thEdDrinking);
//    }
//    #endregion
...
//        if (_myNeeds.GetNeed(NeedType.Health) > _adjFearForLife) {
//            _myNeeds.EditNeed(NeedType.Fear, _feEdIsAttacked);
//        } else {
//            _myNeeds.EditNeed(NeedType.Fear, 2 * _feEdIsAttacked);
//        }
//    }

//    private void CalmDown() {
//        //if no enemy nearby reduce fear
//        _myNeeds.EditNeed(NeedType.Fear, _feEdCalm);
//    }
//    #endregion
...
//        _myNeeds.EditNeed(NeedType.Playfulness, _plEdBored);
//    }

//    private void PlayingWithFriend() {
//        //while playing with friend decrease playfulness
//        _myNeeds.EditNeed(NeedType.Playfulness, _plEdPlayFr);
//    }
//    #endregion
...
//        _myNeeds.EditNeed(NeedType.Curiousity, _cuEdExplore);
//    }
//    private void ExploredArea() {
//        //if within the recognized area
//        _myNeeds.EditNeed(NeedType.Curiousity, _cuEdNoExplore);
//    }
//    #endregion
...
//        _myNeeds.EditNeed(NeedType.Health, _heEdTooHungry);
//    }
...
//        //if in sleep state
//        _myNeeds.EditNeed(NeedType.Energy, _enEdSleep);
//        _myNeeds.EditNeed(NeedType.Hunger, _huEdNoFeedAsleep);
//        _myNeeds.EditNeed(NeedType.Thirst, _thEdNoDrinkAsleep);
//    }

//    private void SawFriendDie() {
//        //if another wolf died nearby
//        _myNeeds.EditNeed(NeedType.Fear, _feEdFriendDie);
//        _myNeeds.EditNeed(NeedType.Curiousity, _cuEdFriendDie);
//    }
//    #endregion
